...
class Modele {
    ...
    public function deleteClient($idclient){
        $requete = "Delete from classe where idclient = :idclient;";
    ...
    public function selectWhereClient($idclient){
        $requete = "Select * from classe where idclient =:idclient;";
        $donnees = array(":idclient" =>$idclient);
        $select = $this->unPDO->prepare ($requete);
        $select -> execute ($donnees);
        return $select->fetch();
    ...
    public function updateProduit($tab){
        $requete = "update professeur set designation=:designation, prixachat = :prixachat,etat= :etat, dateAchat = :dateAchat, idclient = :idclient where idproduit=:idproduit";
        $donnees = array(":designation" => $tab['designation'],
            ":prixachat"=>$tab["prixachat"],
            ":etat"=>$tab["etat"],
            ":dateAchat"=> $tab ["dateAchat"]);
    ...
    public function deleteTechnicien($itechnicien){
    ...
    public function updateTechnicien($tab){
        $requete = "update etudiant set nom=:nom, prenom = :prenom,qualification = :qualification, email= :email where idtechnicien =:idtechnicien";
        $donnees = array(":nom" => $tab['nom'],
            ":prenom"=>$tab["prenom"],
    ...
    public function deleteIntervention($idinter){
        ...
        $donnees = array(":idinter" =>$idprofesseur);
        $select = $this->unPDO->prepare ($requete);
        $select -> execute ($donnees);
    }
