...
<table border="1">
    ...
    if (isset($lestechniciens)){
        foreach ($lestechniciens as $untechnicien){
            ...
            echo "<td>";
            echo "<a href='index.php?page=4&action=sup&idclasse=".$untechniciens['idtech']."'><img src='images/supprimer.png' height='30' width='30'></a>";
            echo "<a href='index.php?page=4&action=edit&idclasse=".$untechniciens['idtech']."'><img src='images/editer.png' height='30' width='30'></a>";
            echo "</td>";
            echo"</td>";
        }
    } ?>
